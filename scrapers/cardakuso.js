// ============================================================================
// scrapers/cardakuso.js — Scraper Cardakuso (Shopify JSON API)
// ============================================================================
...
export default class CardakusoScraper extends BaseScraper {
  constructor(opts = {}) {
    super({
      name: 'cardakuso',
      baseUrl: 'https://cardakuso.fr',
      mode: 'static',
      urls: opts.urls || [
        'https://cardakuso.fr/collections/one-piece-card-game-display/products.json?limit=250',
      ],
      ...opts,
    });
  }
  ...
  _parseProducts(products) {
    ...
    return products
      ...
      .map((p) => {
        ...
        const isPreorderTitle = /pr[eé].?commande|\[pr[eé]|pre.?order/i.test(p.title);
