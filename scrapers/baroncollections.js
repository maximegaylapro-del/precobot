...
export default class BaronCollectionsScraper extends BaseScraper {
  constructor(opts = {}) {
    super({
      name: 'baroncollections',
      baseUrl: 'https://baroncollections.fr',
      mode: 'static',
      urls: opts.urls || [
        'https://baroncollections.fr/collections/nouveautes-de-la-boutique/products.json?limit=250',
      ],
      ...opts,
    });
  }
  ...
  _parseProducts(products) {
    ...
    return products
      ...
      .map((p) => {
        ...
        const isPreorderTitle = /pr[eé]commande|pre.?order/i.test(p.title);
        ...
        return {
          id: `baroncollections_${p.id}`,
          site: 'baroncollections',
          title: p.title.trim(),
          price,
