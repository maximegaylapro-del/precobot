// ============================================================================
// scrapers/nevermint.js — Scraper Nevermint (Shopify JSON API)
// ============================================================================
...
export default class NevermintScraper extends BaseScraper {
  constructor(opts = {}) {
    super({
      name: 'nevermint',
      baseUrl: 'https://nevermint.fr',
      mode: 'static',
      urls: opts.urls || [
        'https://nevermint.fr/collections/one-piece-boites-de-boosters-anglais/products.json?limit=250',
      ],
      ...opts,
    });
  }
  ...
  _parseProducts(products) {
    ...
    return products
      ...
      .map((p) => {
        ...
        const isPreorderTitle = /pre.?order|précommande/i.test(p.title);
